...
describe('.rotate -', function () {
    ...
    it('should rotate the image by 90 degree', function () {
        return easyimg.info(srcimg).then(function (info) {
            ...
            // Mainly check only if width and height are swapped
            return easyimg.rotate({
                src: srcimg,
                dst: __dirname + '/output/rotated.jpg',
                degree: 90
            }).then(function (file) {
                file.should.be.a('object');
...
describe('.rescrop -', function () {
    ...
    it('should resize and crop', function () {
        return easyimg.rescrop({
            src: srcimg,
            dst: __dirname + '/output/rescrop.jpg',
            width: 400,
            height: 5400,
            cropwidth: 100,
            cropheight: 100,
...
describe('.thumbnail -', function () {
    ...
    it('should generate a thumbnail', function () {
        return easyimg.thumbnail({
            src: srcimg,
            dst: __dirname + '/output/thumb nail.jpg',
            width: 128,
            height: 128,
            x: 0,
            y: 0
...
describe('.execute -', function () {
    ...
    it('should invoke `convert` command', function () {
        return easyimg.execute('convert', [srcimg, './output/hello\\ kitty.gif']);
...
describe('additionals', function () {
    ...
    it('should create directories if they do not exist', function () {
        ...
        return easyimg.thumbnail({
            src: srcimg,
            dst: __dirname + '/output/foo/bar/hey.jpg',
            width: 128,
            height: 128,
            x: 0,
            y: 0
